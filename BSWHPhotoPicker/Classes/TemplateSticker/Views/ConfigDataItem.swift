...
public enum TemplateCategory: String, Codable {
    case christmas = "Christmas"
    case baby = "Baby"
    case birthday = "Birthday"
    case weddingParty = "WeddingParty"
    case travel = "Travel"
...
class ConfigDataItem {
    ...
    static func getTemplateListData(forVideo: Bool = false) -> [[TemplateModel]] {
        ...
        let item07 = TemplateModel(imageName: "Christmas08",imageBg: "Christmas00-bg",jsonName: "Christmas07", photoCount: 1)
        let item08 = TemplateModel(imageName: "Christmas09",imageBg: "Christmas02-bg",jsonName: "Christmas08", photoCount: 1)
        let item09 = TemplateModel(imageName: "Christmas10",imageBg: "Christmas09-bg",jsonName: "Christmas09", photoCount: 1)
        let item010 = TemplateModel(imageName: "Christmas11",imageBg: "Christmas10-bg",jsonName: "Christmas10", photoCount: 1)
        let item011 = TemplateModel(imageName: "Christmas12",imageBg: "Christmas11-bg",jsonName: "Christmas11", photoCount: 1)
        ...
        let item32 = TemplateModel(imageName: "Wedding02",imageBg: "wedding02-bg",jsonName: "Wedding02", photoCount: 5)
        ...
        let item54 = TemplateModel(imageName: "Scrapbook04",imageBg: "Scrapbook04-bg",jsonName: "Scrapbook04", photoCount: 2)
